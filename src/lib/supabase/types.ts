...
export type MoveType = 'clue' | 'guess' | 'end_turn' | 'place_tiles' | 'exchange_tiles' | 'pass' | 'challenge' | 'submit_clues' | 'place_cards' | 'submit_guess' | 'take_control' | 'acknowledge_result';
